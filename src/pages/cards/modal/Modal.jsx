            ...
            <div className='text'>
               ...
               <div className='closing'>
                  ...
                  <p>
                     ...
                     구현을 담당하며 HTML, CSS, JavaScript로 사용자 인터페이스를 설계했고 와이어프레임부터 실제
                     화면까지 구현하면서 UI/UX 설계의 중요성을 체감했습니다. 결제 기능과 마이페이지의 개인정보 수정
                     기능을 CRUD로 구현하며 데이터 처리와 보안을 이해했고 Spring Boot와 Thymeleaf를 활용해 백엔드와
                     프론트엔드 간의 데이터를 연결하고 서버 로직을 통해 사용자 입력을 처리하는 흐름을 익혔습니다. 이번
                     프로젝트를 통해 특히 협업에서의 소통 중요성을 깊이 깨달았습니다. 팀원들과의 진행 상황 공유가 미흡할
                     경우 작은 문제가 큰 오류로 이어질 수 있다는 점을 경험했습니다. 예를 들어 프론트엔드 UI가 백엔드
                     API와 맞지 않아 디버깅에 시간을 소요했는데 사전 소통이 있었다면 시간을 절약할 수 있었을 것입니다.
                     이후 주기적인 스크럼 회의를 통해 진행 상황을 점검하고 협력하며 문제 해결 속도와 효율성이 크게
                     향상되었습니다. 이를 통해 협업에서 소통은 필수적이며 프로젝트의 성공적 완료를 위해 반드시 신경
                     써야 한다는 점을 깨달았습니다.
                  </p>
               </div>
            </div>
